  ...
  itemListElement: [
    {
      ...
      position: 1,
      name: 'Inicio',
      item: 'https://fisio-movimiento.com/',
    },
    {
      '@type': 'ListItem',
      position: 2,
      name: 'Servicios',
      item: 'https://fisio-movimiento.com/#servicios',
    },
    {
      '@type': 'ListItem',
      position: 3,
      name: 'Precios',
      item: 'https://fisio-movimiento.com/#precios',
    },
    {
      '@type': 'ListItem',
      position: 4,
      name: 'Testimonios',
      item: 'https://fisio-movimiento.com/#testimonios',
    },
    {
      '@type': 'ListItem',
      position: 5,
      name: 'Contacto',
      item: 'https://fisio-movimiento.com/#contacto',
    },
  ],
});
