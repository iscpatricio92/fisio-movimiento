...
const getServiceIcon = (serviceName: string) => {
  ...
  if (name.includes('consulta') || name.includes('primera vez'))
    return Stethoscope;
  if (
  ...
  if (name.includes('ejercicio') || name.includes('fortalecimiento'))
    return Dumbbell;
    ...
    services: [
      {
        ...
        price: '700',
        description:
          'Evaluación completa inicial con diagnóstico y plan de tratamiento',
      },
      {
...
export const PricingSection = () => {
  ...
  return (
    <section
      id="precios"
      className="py-12 lg:py-24 bg-background overflow-hidden"
    >
        ...
        <ScrollAnimated animation="fade-up" delay={100}>
          <div className="grid gap-3 lg:gap-8 lg:grid-cols-3 mb-6 lg:mb-16">
            {plans.map((plan, index) => (
              ...
              >
                <div
                  className={`relative rounded-xl lg:rounded-3xl transition-all duration-200 active:scale-[0.98] ${
                    plan.popular
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-1.5 mt-1 flex-wrap">
                          {plan.features.slice(0, 5).map((feature, i) => (
                            ...
                            >
                              <Check
                                className={`w-2.5 h-2.5 ${plan.popular ? 'text-primary-foreground' : 'text-primary'}`}
                              />
                              {feature}
                            </span>
                          ))}
