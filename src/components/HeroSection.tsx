...
import therapistImage from '@/assets/analaura-reyes-fisioterapeuta.jpg';
// Responsive image sizes for srcset
import therapistImageWebP400 from '@/assets/analaura-reyes-fisioterapeuta.jpg?w=400&format=webp';
import therapistImageWebP800 from '@/assets/analaura-reyes-fisioterapeuta.jpg?w=800&format=webp';
import therapistImageWebP1200 from '@/assets/analaura-reyes-fisioterapeuta.jpg?w=1200&format=webp';
...
export const HeroSection = () => {
  return (
    ...
    >
      ...
      <div
        className="hidden md:block absolute bottom-1/4 right-10 w-96 h-96 bg-primary-foreground/15 rounded-full blur-3xl animate-float opacity-50"
        style={{ animationDelay: '2s' }}
      />
      <div
        className="hidden md:block absolute top-1/2 right-1/4 w-64 h-64 bg-primary/20 rounded-full blur-3xl animate-float opacity-40"
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-primary-foreground space-y-6 lg:space-y-8 animate-fade-up order-2 lg:order-1">
            ...
            <p className="text-sm sm:text-base lg:text-lg opacity-90 max-w-xl leading-relaxed">
              ...
              <span className="hidden sm:inline">
                Tratamientos personalizados y basados en evidencia para
            ...
            <div className="flex flex-col sm:flex-row gap-3 lg:gap-4 pt-2">
              <Button
                variant="hero"
                size="lg"
                className="w-full sm:w-auto lg:text-base"
                asChild
              >
                <a
                  href="#agenda"
                ...
                >
                  ...
                  <span className="flex flex-col items-start leading-tight">
                    ...
                    <span className="text-[10px] lg:text-xs opacity-80 font-normal">
                      Próxima disponible: mañana
                    </span>
                  </span>
                </a>
              </Button>
          ...
          >
            <div className="relative max-w-[280px] sm:max-w-[320px] lg:max-w-none mx-auto lg:mx-0">
              ...
              <div
                className="hidden lg:block absolute -bottom-6 -left-6 bg-card rounded-2xl p-6 shadow-glow border border-border/50 animate-slide-in hover:scale-105 transition-transform duration-300"
