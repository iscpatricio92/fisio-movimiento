  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body active:scale-[0.97]',
  {
    variants: {
      variant: {
        ...
        hero: 'gradient-cta text-white shadow-lg hover:shadow-glow hover:-translate-y-1 px-8 py-4 text-base font-bold hover:scale-105',
        heroOutline:
          'border-2 border-primary-foreground/30 bg-primary-foreground/10 text-primary-foreground hover:bg-primary-foreground/20 backdrop-blur-md px-8 py-4 text-base font-semibold hover:scale-105',
        cta: 'gradient-cta text-white shadow-md hover:shadow-glow hover:-translate-y-0.5 font-semibold hover:scale-105',
      },
      size: {
